...
@Suite("Settings Invariants")
@MainActor
struct SettingsInvariantTests {
    ...
    func enablingShowAllSpaces_disablesShowAllDisplays() {
        ...
        SettingsInvariantEnforcer.setShowAllSpaces(true, store: store)
    ...
    func enablingShowAllDisplays_disablesShowAllSpaces() {
        ...
        SettingsInvariantEnforcer.setShowAllDisplays(true, store: store)
    ...
    func disablingShowAllSpaces_doesNotAffectShowAllDisplays() {
        ...
        SettingsInvariantEnforcer.setShowAllSpaces(false, store: store)
    ...
    func disablingShowAllDisplays_doesNotAffectShowAllSpaces() {
        ...
        SettingsInvariantEnforcer.setShowAllDisplays(false, store: store)
    ...
    func clickToSwitchSpaces_failsWithoutAccessibility() {
        ...
        let result = SettingsInvariantEnforcer.setClickToSwitchSpaces(true, store: store)
    ...
    func clickToSwitchSpaces_canAlwaysBeDisabled() {
        ...
        let result = SettingsInvariantEnforcer.setClickToSwitchSpaces(false, store: store)
