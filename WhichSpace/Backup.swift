...
enum BackupManager {
    ...
    static func encode(store: DefaultsStore = .shared) throws -> String {
    ...
    static func load(from url: URL, store: DefaultsStore = .shared) throws {
    ...
    static func export(to url: URL, store: DefaultsStore = .shared) throws {
