...
enum Localization {
    ...
    static let labelStyleRounded = String(localized: "label_style_rounded")
    static let labelStyleRoundedOutline = String(localized: "label_style_rounded_outline")
