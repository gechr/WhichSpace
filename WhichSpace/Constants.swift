...
enum Localization {
    ...
    static let actionResetSoundToDefault = NSLocalizedString("action_reset_sound_to_default", comment: "")
    ...
    static let confirmResetSound = NSLocalizedString("confirm_reset_sound", comment: "")
    ...
    static let detailResetSound = NSLocalizedString("detail_reset_sound", comment: "")
