...
enum Layout {
    ...
    /// Characters the field shows at its narrowest
    static let menuLabelFieldMinimumCharacters = 20
    /// Space reserved for the clear button at the trailing end
    static let menuLabelFieldClearButtonWidth = 24.0
...
enum Localization {
    ...
    static let alertClickToSwitchDetail = String(localized: "alert_click_to_switch_detail")
    static let alertClickToSwitchTitle = String(localized: "alert_click_to_switch_title")
    ...
    static let buttonKeepOff = String(localized: "button_keep_off")
    static let buttonOK = String(localized: "button_ok")
    static let buttonOpen = String(localized: "button_open")
    static let buttonReplace = String(localized: "button_replace")
    ...
    static let buttonTurnOn = String(localized: "button_turn_on")
